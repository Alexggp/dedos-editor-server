...
const filesSchema = new Schema({
  ...
  projectId: { type: Schema.Types.ObjectId, ref: 'Projects' },
  activityId: { type: Schema.Types.ObjectId, ref: 'Activities' },
  containerId: { type: Schema.Types.ObjectId, refPath: 'model_type' },
  model_type: { type: String, enum: ['Token', 'Areas'] },
  fileName: String
});
...
module.exports = { ProjectsModel, ActivitiesModel, AreasModel, TokensModel, ObjetivesModel, FilesModel };